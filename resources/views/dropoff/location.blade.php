...
<head>
    ...
    <title>Drop-off Location - Clastic</title>
    ...
    <div class="location-container">
        ...
        <div class="header-gradient">
            <div class="flex items-center mb-2">
                ...
                <h1 class="text-2xl font-bold">Set Your Drop-off Location</h1>
            </div>
            <p class="text-teal-100 text-sm">Choose your drop-off point for plastic collection</p>
        </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        document.getElementById("confirmBtn").addEventListener("click", function () {
            if (selectedLocation) {
                sessionStorage.setItem("dropoffLocation", JSON.stringify(selectedLocation));
                window.location.href = "/dropoff/schedule";
            }
        });
