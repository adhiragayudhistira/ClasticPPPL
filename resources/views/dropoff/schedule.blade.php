...
<style>
    ...
    html, body {
        ...
        padding: 0;
        height: 100%;
        background: #e5f0ee; /* abu2 kehijauan, biar gak terlalu beda */
...
<div class="schedule-container">
    ...
    <div class="schedule-header">
        ...
        <p class="text-teal-100 text-sm">Determine your drop-off schedule</p>
    </div>

    <!-- Konten -->
    <div class="schedule-content">
        <h2 class="section-title">Schedule</h2>
        <p class="section-subtitle">Choose your preferred time for drop-off</p>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmBtn.addEventListener('click', function() {
            ...
            if (selected) {
                // simpan jadwal drop-off di browser
                sessionStorage.setItem('dropoffSchedule', selected.value);
                // lanjut ke halaman plastic type drop-off
                window.location.href = '/dropoff/plastic-type';
            }
        });
    });
</script>
